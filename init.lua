...
--  See `:help 'list'`
--  and `:help 'listchars'`
-- Make listchars visible and distinct
vim.opt.list = true
vim.opt.listchars = {
	tab = "  ",
	trail = "·",
...
require("lazy").setup({
...

	{
		...
		config = function()
			require("catppuccin").setup({
				...
				color_overrides = {
					mocha = {
						base = "#1a1d2a", -- lighter (was #0f111a), closer to surface0
						mantle = "#212432", -- closer to surface1
						crust = "#2a2d3c", -- closer to surface2
	...
	},
	{
		...
		config = function()
			require("image").setup({
				backend = "kitty", -- or "ueberzug", "viu", "tycat"
				integrations = {
					markdown = {
						enabled = false, -- <-- turn this OFF to avoid the Treesitter crash
